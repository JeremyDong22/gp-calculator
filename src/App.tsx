// v2.0 - Premium Financial Dashboard with glass morphism design
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '0.75rem', color: '#64748b', margin: 0 }}>项目毛利计算系统</p>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div>
              <p style={{ fontSize: '0.9375rem', fontWeight: 500, margin: 0, color: '#f8fafc' }}>
                {currentUser.name}
              </p>
